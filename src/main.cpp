...
// Initialize I2C pins and OLED hardware (deferred call in setup)
void initI2CAndOLED();
...
// Initialize Wire1 and the OLED hardware. Called once from setup().
void initI2CAndOLED() {
  ...
  // Initialize the static display object now that Wire1 is configured
